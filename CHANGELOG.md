...
### Added
- Add JSDocs to `createBarcodeScanner()`
- Add `@typedef` for `DetectedBarcode`

### Changed
- `createBarcodeScanner()` can now be passed in a `<video>` or ID for a `<video>`, creating one if not given

## [v1.2.1] - 2025-12-10

### Changed
- More misc perofrmance improvements
